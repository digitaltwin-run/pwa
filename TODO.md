...
Przenies wszystko co zwiazane z interakcjami do nowego projektu ../interactions, np usun scriptContent interactions przy eksporrcie SVG z projektu pwa/js/export.svg

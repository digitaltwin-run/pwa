...
export class PropertyUIGenerator {
    constructor() {
        this.eventLabels = {
            'click': window.t ? window.t('events.click') : 'Kliknięcie',
            'doubleclick': window.t ? window.t('events.doubleclick') : 'Podwójne kliknięcie',
            'mousedown': window.t ? window.t('events.mousedown') : 'Naciśnięcie myszy',
            'mouseup': window.t ? window.t('events.mouseup') : 'Zwolnienie myszy',
            'mouseover': window.t ? window.t('events.mouseover') : 'Najechanie myszą',
            'mouseout': window.t ? window.t('events.mouseout') : 'Opuszczenie myszą',
            'focus': window.t ? window.t('events.focus') : 'Uzyskanie fokusu',
            'blur': window.t ? window.t('events.blur') : 'Utrata fokusu',
            'change': window.t ? window.t('events.change') : 'Zmiana wartości',
            'input': window.t ? window.t('events.input') : 'Wprowadzanie tekstu',
            'keydown': window.t ? window.t('events.keydown') : 'Naciśnięcie klawisza',
            'keyup': window.t ? window.t('events.keyup') : 'Zwolnienie klawisza',
            'press': 'Naciśnięcie',
            'release': 'Zwolnienie',
            'toggle': 'Przełączenie',
            'on': 'Włączenie',
